...
| Arena run | `arena_visual_candidate_20260817` on SSH worker `hucenrotia-ai` |
...
The current arena candidate was executed on SSH with:
...
- candidate source tree ID: `68ae42a9b4a815884358c5879afa31a974b56b054b29697731d330c01cfba2bb`

The exact configuration, command, timestamp, dependency versions, model hash, and artifact paths are recorded in each arena `logs/manifest.json`. The source commit is the repository authority; the SSH workspace is an execution copy only.
