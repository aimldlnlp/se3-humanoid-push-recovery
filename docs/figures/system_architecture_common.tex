...
\newcommand{\DrawArchitectureHorizontalFinal}{%
  \begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \node[archinput,anchor=east,text width=27mm] (hdesired) at (2.65,3.15)
    ...
    \node[archplant] (hplant) at (14.90,3.15)
      ...
      {\scriptsize floating base}\\[-1pt]
      {\scriptsize fixed-foot double support}};
    ...
    \draw[archsignal] (hdesired.east) --
      node[archlabel,above=8pt] {targets}
      (htask.west);
    \draw[archsignal] (htask.east) --
      node[archmathlabel,above=1.5pt] {$a^\star$}
      (hqp.west);
    ...
    \node[archmeasurelabel,anchor=west,align=left] at (15.05,1.72)
      {state + contacts\\ actual GRF};
  \end{tikzpicture}%
}
