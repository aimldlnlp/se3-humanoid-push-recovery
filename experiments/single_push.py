...
from se3_whole_body_control.visualization.plots import plot_actual_grf, plot_com_support_polygon, plot_contact_wrench_consistency, plot_flagship, plot_trial
...
def main() -> None:
    ...
    if wbc_run is not None:
        for plotter, name in ((plot_flagship, "canonical_response"), (plot_actual_grf, "actual_ground_reaction_forces"), (plot_contact_wrench_consistency, "contact_wrench_consistency"), (plot_com_support_polygon, "com_support_polygon")):
